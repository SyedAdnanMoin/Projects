...
%>
        <a href="Gotocart.jsp" style="float:right">Go to cart: <%out.println(tot);%></a>
<%               
...
%>           
   ...
   <!-- <div class="row"> -->
    ...
    <% if("exist".equals(msg))
    	{%>
    <h3>Product already exists in your cart! Quantity increased</h3>
    <% }%>
